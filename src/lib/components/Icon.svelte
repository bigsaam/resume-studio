<script lang="ts">
	// Self-contained inline SVG set — no icon dependency. Add a path here to add
	// an icon. All are 24x24, stroked with currentColor.
	interface Props {
		name: string;
		size?: number;
		class?: string;
	...
	const paths: Record<string, string> = {
		resumes: 'M4 4a2 2 0 0 1 2-2h7l5 5v13a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2z M13 2v5h5',
		templates: 'M3 3h7v7H3z M14 3h7v4h-7z M14 11h7v10h-7z M3 14h7v7H3z',
		settings:
	...
	let d = $derived(paths[name] ?? paths.file);
</script>
